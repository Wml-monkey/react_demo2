...
class Lianxiti2 extends React.Component{
    ...
    componentDidMount(){
        let finall_cont = document.querySelectorAll('.inall_cont')[1];
        console.log(finall_cont)
    ...
    componentWillReceiveProps(){//父级参数发生变化，就会进去
        let {click_open} = this.state;
            ...
            <div className="finall_cont fl">
                <div className="ti_cont">
                    ...
                    <dd data-answer={ti_tip*(1)} onClick={this.panduan}>
                        <span className="a" style={style_false}>{option[0]}</span>
                        <em>{cont.optionA}</em>
                    </dd>
