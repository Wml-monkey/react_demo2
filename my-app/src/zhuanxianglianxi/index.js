...
class ZhuanXinagLianXiIndex extends React.Component{
    ...
    componentDidMount(){
        ...
        let temp_url12 = "https://api2.jiakaobaodian.com/api/open/exercise/strengthen.htm?_appName=jiakaobaodian&_platform=wap&_r=16294305145712892084&carType=car&cityCode=110000&course=kemu1&_=0.6298276790906017";
    ...
    render(){
        ...
        let neirong = (arr)=>{
            ...
            let temp_arr1 = arr.map((e,i)=>{
                    return <a href={"/monikaoshi/zhuanxianglianxi_index/"+e.action.split("?")[1]}>{e.label}</a>
                });
...
<div className="zhangjie_dibu">
         <div className="lujing">
                ...
                <a href="" className="jiantou">专项练习</a>
            </div>
